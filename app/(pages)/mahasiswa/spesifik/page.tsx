      ...
      <div className="relative p-6 text-white">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="mt-1 text-sm text-white/90">
            Informasi mahasiswa yang cocok telah ditemukan.
          </p>
        </div>
      </div>
      ...
      <div className="p-5">
        <ul className="grid gap-3">
          <InstructionStep
            ...
            description="Isi Nomor Induk Mahasiswa yang akan dicari."
          />
          <InstructionStep
  ...
  const handleSearch = async (e: FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/mahasiswa/spesifik?${params.toString()}`
      );
        ...
        {searchResult && (
          <ResultPopup
            ...
            onConfirm={() => {
              ...
              router.push(
                `/mahasiswa/detail/${encodeURIComponent(searchResult.id)}`
              );
            }}
        ...
        <main className="mx-auto w-full max-w-2xl">
          ...
          <header className="text-center my-8 sm:my-12">
            ...
            <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              ...
              milik mahasiswa yang dituju demi hasil yang akurat.
            </p>
          </header>
                  ...
                  <div className="relative">
                    <Hash
                      ...
                      className={`pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 ${
                        nim.trim() ? "text-blue-600" : "text-gray-400"
                      }`}
                    />
                    <input
                      id="nim"
                  ...
                  {notFound && (
                    <div className="flex items-center gap-2 rounded-md border border-amber-200 bg-amber-50 p-3 text-amber-800">
                      ...
                      <span className="text-sm font-medium">
                        Mahasiswa tidak ditemukan. Periksa kembali data Anda.
                      </span>
                    </div>
                  )}
                </div>
