...
const sortingFn = (a: Dosen, b: Dosen, sortBy: string) => {
...
export default function DosenPageClient() {
    const hookProps = useSearchPage<Dosen>({
        historyKey: "pddikti_dosen_history",
        sortingFn,
    });
        ...
        >
            <main className="w-full max-w-4xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <Link href="/dosen/spesifik" className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-blue-600 group transition-colors">
                ...
                <div className="grid grid-cols-1 gap-5">
                    ...
                    {!loading &&
                        paginatedResults.map((dosen, index) => (
                            <DosenCard key={(dosen as any).id} dosen={dosen} index={index} />
                        ))}
                </div>
