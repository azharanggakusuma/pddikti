...
import {
    ...
    Loader2, X, SlidersHorizontal, UserCheck
} from "lucide-react";
...
export default function MahasiswaPage() {
    const {
        ...
        sortBy, setSortBy, filterPT, setFilterPT, filterProdi, setFilterProdi, searchQuery, setSearchQuery,
        handleNewSearch, searchHistory, isSearchFocused, setIsSearchFocused, searchInputRef, searchWrapperRef, handleDeleteHistory,
        showBackToTop, allResults, processedResults, suggestion
    } = useSearchPage<Mahasiswa>({
