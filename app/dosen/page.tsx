...
import { FileX, ArrowUp, Search, History, Loader2, X, SlidersHorizontal, User } from 'lucide-react';
...
export default function DosenPage() {
    ...
    const [results, setResults] = useState<Dosen[]>([]);
            ...
            <main className="w-full max-w-4xl mx-auto">
                <header className="text-center my-12">
                    ...
                    <p className="mt-4 text-lg text-gray-600">
                        Masukkan nama atau NIDN untuk memulai pencarian.
                    </p>
                </header>
                ...
                <div className="grid grid-cols-1 gap-5">
                    ...
                    {!loading && results.map((dosen, index) => <DosenCard key={dosen.id} dosen={dosen} index={index} />)}
                </div>
