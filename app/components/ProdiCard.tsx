    ...
    return (
        ...
        >
            <div className="flex justify-between items-start">
                <div>
                    <h2 className="font-bold text-lg text-gray-800 truncate" title={prodi.nama}>{prodi.jenjang} - {prodi.nama}</h2>
                </div>
                <div
            ...
            <div className="mt-4 pt-4 border-t border-dashed border-gray-200 text-sm text-gray-600 space-y-2">
                <p className="flex items-center"><University size={16} className="mr-3 text-gray-400"/> {prodi.pt}</p>
            </div>
        </div>
    );
};