    ...
    return (
        ...
        >
            ...
            <div className="mt-4 pt-4 border-t border-dashed border-gray-200 text-sm text-gray-600 space-y-2">
                <p className="flex items-center"><University size={16} className="mr-3 text-gray-400"/> {dosen.nama_pt}</p>
                <p className="flex items-center"><BookText size={16} className="mr-3 text-gray-400"/> {dosen.nama_prodi}</p>
            </div>
        </div>
    );
};